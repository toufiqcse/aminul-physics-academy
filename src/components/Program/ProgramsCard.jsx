           ...
           <div className=''>
            ...
            <div className='px-4 py-4 font-noto'>
                ...
                <div className='flex justify-between items-center  mt-6 text-white/90'>
                    ...
                    <NavLink className='text-[15px]  font-semibold rounded-full px-6 py-2 bg-gradient-to-r  from-[#EF512E] to-[#DE0655] shadow-md' to="/register">{enrol}</NavLink>
                </div>
            </div>
